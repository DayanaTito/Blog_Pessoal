...
public class UsuarioControllerTest {
	...
	@Autowired
	private TestRestTemplate testRestTemplate; // pode consumir a api de terceiros, vai fazer o papel do imsomnia
	...
	@BeforeAll
	void start() { // método para o banco de dados seja zerado
	...
	@Test
	@Order(5)
	@DisplayName("Listar um usuário por id")
	public void deveListarApenasUmUsuario() {
		Optional<Usuario> buscaUsuario = usuarioService.cadastrarUsuario(new Usuario(0L, "Dayana Tito",
				"Dayanatito@email.com.br", "Dayana123", "https://i.imgur.com/Sk5SjWE1.jpg"));
		ResponseEntity<String> resposta = testRestTemplate.withBasicAuth("root", "root").exchange("/usuarios/" + buscaUsuario.get().getId(),
				HttpMethod.GET, null, String.class);
	...
	public void deveAutenticarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Dayana Choque", "Dayana_Choque@email.com.br", "13465278", "https://i.imgur.com/Sk5SjWE2.jpg"));
		HttpEntity<UsuarioLogin> corpoRequisicao= new
				HttpEntity<UsuarioLogin> (new UsuarioLogin(0L,"", "Dayana_Choque@email.com.br", "13465278","",""));
